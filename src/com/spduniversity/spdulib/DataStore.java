...
public class DataStore {
    ...
    public DataStore() {
        Initializer.initializeUsers(users);
        Initializer.initializeBooks(items);
        Initializer.initializeOnlineCourses(items);
    ...
    private static class Initializer {
        public static void initializeUsers(User[] users) {
        ...
        public static void initializeBooks(Item[][] items) {
        ...
        public static void initializeOnlineCourses(Item[][] items) {
