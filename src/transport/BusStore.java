...
public class BusStore {
    ...
    public Bus bus43 = new Bus(43, Routes.FOUR, 10, Routes.FOUR.getStops()[0]);
    ...
    public Bus bus73 = new Bus(73, Routes.SEVEN, 0, Routes.ELEVEN.getStops()[1]);
    ...
    public Bus bus112 = new Bus(112, Routes.ELEVEN, 55, Routes.ELEVEN.getStops()[0]);
